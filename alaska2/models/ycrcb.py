    ...
    def forward(self, **kwargs):
        x = torch.cat(
            [
                ...
                F.interpolate(kwargs[INPUT_FEATURES_CHANNEL_CR_KEY], scale_factor=2, mode="nearest"),
                F.interpolate(kwargs[INPUT_FEATURES_CHANNEL_CB_KEY], scale_factor=2, mode="nearest"),
            ],
            dim=1,
        )
