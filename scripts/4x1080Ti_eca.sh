...
python -m torch.distributed.launch --nproc_per_node=4 train_d.py -m rgb_tf_efficientnet_b6_ns -b 8 -w 6 -d 0.2 -s flat_cos -o Ranger --epochs 75 -a hard\
  --modification-flag-loss bce 1 --modification-type-loss ce 1 -lr 1e-3 --fold 0 --seed 10000 -v --fp16 -c /home/bloodaxe/develop/Kaggle-2020-Alaska2/runs/May28_13_04_rgb_tf_efficientnet_b6_ns_fold0_local_rank_0_fp16/main/checkpoints_auc_classifier/best.pth

python -m torch.distributed.launch --nproc_per_node=4 train_d.py -m rgb_tf_efficientnet_b6_ns -b 8 -w 6 -d 0.2 -s flat_cos -o Ranger --epochs 75 -a hard\
  --modification-flag-loss binary_focal 1 --modification-type-loss focal 1 -lr 1e-3 --fold 0 --seed 10000 -v --fp16 -c /home/bloodaxe/develop/Kaggle-2020-Alaska2/runs/May28_13_04_rgb_tf_efficientnet_b6_ns_fold0_local_rank_0_fp16/main/checkpoints_auc_classifier/best.pth
