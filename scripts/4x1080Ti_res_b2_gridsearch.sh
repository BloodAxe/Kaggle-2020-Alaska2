...
python -m torch.distributed.launch --nproc_per_node=4 train_d.py -m rgb_res_sms_v2_tf_efficientnet_b2_ns -b 14 -w 8 -d 0.2 -s cos -o SGD --epochs 50 -a light\
  --modification-flag-loss bce 1 --modification-type-loss ce 1 -lr 1e-2 -wd 1e-5 --fold 0 --seed 10000 -v --fp16\
  --transfer /home/bloodaxe/develop/Kaggle-2020-Alaska2/runs/Jun17_23_57_rgb_res_sms_tf_efficientnet_b2_ns_fold0_local_rank_0_fp16/main/checkpoints_auc/last.pth
