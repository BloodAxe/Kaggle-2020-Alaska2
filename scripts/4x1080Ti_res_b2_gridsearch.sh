...
python -m torch.distributed.launch --nproc_per_node=4 train_d.py -m rgb_res_tf_efficientnet_b2_ns -b 24 -w 8 -d 0.2 -s cos -o SGD --epochs 50 -a hard\
  ...
  --c /home/bloodaxe/develop/Kaggle-2020-Alaska2/runs/Jun16_16_10_rgb_res_tf_efficientnet_b2_ns_fold0_local_rank_0_fp16/main/checkpoints_auc_classifier/best.pth
