...
#  --modification-flag-loss wbce 1 --modification-type-loss focal 1 -lr 5e-3 --fold 0 --seed 100 -v --fp16\
...
python -m torch.distributed.launch --nproc_per_node=4 train_d_paired.py\
  -m rgb_tf_efficientnet_b6_ns -b 8 -w 6 -d 0.2 -s cos -o SGD --epochs 25 -a medium\
  --modification-flag-loss bce 1 --modification-type-loss ce 1 -lr 1e-3 -v --fp16\
  --fold 0 --seed 100\
