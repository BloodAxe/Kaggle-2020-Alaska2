...
python train.py -m ela_skresnext50_32x4d -b 112 -w 16 -d 0.2 -s flat_cos -o Ranger --epochs 75 -a light\
  --modification-flag-loss bce 0.1 --modification-type-loss ce 1 -lr 1e-3 --fold 0 --seed 0 --fp16 --fine-tune 10

python train.py -m ela_skresnext50_32x4d -b 112 -w 16 -d 0.2 -s flat_cos -o Ranger --epochs 75 -a light\
  --modification-flag-loss bce 0.1 --modification-type-loss ce 1 -lr 1e-3 --fold 3 --seed 3 --fp16 --fine-tune 10