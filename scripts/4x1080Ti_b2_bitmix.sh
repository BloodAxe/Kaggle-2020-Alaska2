...
python -m torch.distributed.launch --nproc_per_node=4 train_d_paired.py -m rgb_tf_efficientnet_b2_ns -b 28 -w 6 -d 0.2 -s cos -o SGD --epochs 75 -a light\
  --modification-flag-loss wbce 1 -lr 1e-2 --fold 0 -v --fp16
