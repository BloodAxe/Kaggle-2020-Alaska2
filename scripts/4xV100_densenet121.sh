...
nohup python train.py -m rgb_densenet201 -b 80 -w 24 -s cos --epochs 100 -a safe\
  --modification-flag-loss bce 1 --modification-type-loss ce 0.01 -v -lr 1e-4 --fold 3 --seed 3 -wd 1e-5 --fp16 -c /home/ubuntu/code/Kaggle-2020-Alaska2/runs/May10_16_32_rgb_densenet201_fold3_fp16/main/checkpoints_auc/last.pth > rgb_densenet201_fold3.log &