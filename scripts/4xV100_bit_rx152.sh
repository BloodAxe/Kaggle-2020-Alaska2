...
python -m torch.distributed.launch --nproc_per_node=4 train_d.py -m bit_m_rx152_2 -b 3 -w 6 -d 0.2 -s cos -o fused_sgd --epochs 50 -a hard\
  --modification-flag-loss bce 1 --modification-type-loss ce 0.5 -lr 1e-2 --fold 3 --seed 40 -v --fp16
