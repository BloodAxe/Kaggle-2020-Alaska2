...
python -m torch.distributed.launch --nproc_per_node=4 train_d.py\
  ...
  --fold 0 --seed 100\
  --transfer /home/bloodaxe/develop/Kaggle-2020-Alaska2/runs/Jul03_21_14_nr_rgb_tf_efficientnet_b6_ns_fold0_local_rank_0_fp16/main/checkpoints_auc_classifier/best.pth
