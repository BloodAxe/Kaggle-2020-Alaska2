...
python train.py -m rgb_resnet34 -b 160 -w 16 -d 0.2 -s cos --epochs 100 --fine-tune 10 -a safe\
  --modification-flag-loss bce 1 --modification-type-loss ce 0.1 --embedding-loss ccos 1.0 -v -lr 1e-4 --fold 0 --seed 12340 --balance
