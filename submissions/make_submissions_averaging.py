...
def main():
    ...
    experiments = [
        ...
        "Jun24_22_00_rgb_tf_efficientnet_b2_ns_fold2_local_rank_0_fp16",
        #
    ...
    if True:
        for metric in ["loss", "bauc", "cauc"]:
            ...
            blend_classifier_mean_d4 = blend_predictions_mean(cls_pred_d4)
            print(
                metric, "Mean", "Classifier calibrated", "  ", alaska_weighted_auc(y_true, blend_classifier_mean.Label)
            )
            print(
                metric,
                "Mean",
                ...
                "hv",
                alaska_weighted_auc(y_true, blend_classifier_mean_hv.Label),
            )
            print(
                metric,
                "Mean",
                "Classifier calibrated",
                "d4",
                alaska_weighted_auc(y_true, blend_classifier_mean_d4.Label),
            )
