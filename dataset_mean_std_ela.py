...
from alaska2.dataset import idct8v2, compute_decoding_residual, compute_ela_rich
...
def compute_mean_std(dataset):
    ...
    for image_fname in dataset:
        residual = compute_ela_rich(cv2.imread(image_fname))
...
def main():
    ...
    dataset = fs.find_images_in_dir(cover)
